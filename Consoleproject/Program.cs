...
namespace Consoleproject
{
    internal class Program
    {
        ...
        public static int a, a2, a5, b,a12,a14,a20,a10;
        public static string a3, a1, a4;
        public static List<string> d3 = new List<string>();
        public static List<int> d4 = new List<int>();
        public static double total1, gst1;
        ...
        Y: Console.WriteLine(" Choose the Login type");
            ...
            if (a == 2)
            {
                ...
                if (a12 != 0)
                {
                    ...
                    {
                        Console.WriteLine("please enter the number you want to add the item in your  cart(index number):");
                ...
                O: Console.WriteLine("Do You want to continue shopping");
                    ...
                    if (a12 == 1)
                    {
                        ...
                        for (int i = 0; c10.Length > i; i++)
                        {
                            ...
                            Console.WriteLine("please enter the number you want to add the item in your cart: ");
